...
const Layout = ({ children }) => {
  return (
    <div className="flex items-center justify-center h-screen bg--900">
      ...
      <div className="lg:w-[20rem] mg:w-[20rem] sm:border-2 border-black/60 sm:w-[20rem] w-full lg:h-[82vh] md:h-[82vh] h-full sm:rounded-lg overflow-hidden relative bg--300">
        <Header />
